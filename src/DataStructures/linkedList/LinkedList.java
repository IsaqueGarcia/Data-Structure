...
public class LinkedList {
    ...
    public static void main(String[] args) {
        ...
        linkedList.printList();
//        DataStructures.linkedList.printList();
//
//        System.out.println("=======After remove========");
//        DataStructures.linkedList.removeLast();
//        DataStructures.linkedList.printList();
//
//        System.out.println("=======After include a new node in the begin========");
//        DataStructures.linkedList.prepend(15);
//        DataStructures.linkedList.printList();
//
//        System.out.println("=======After remove the first node========");
//        DataStructures.linkedList.removeFirst();
//        DataStructures.linkedList.printList();
//
//        System.out.println("=======Get by index========");
//        System.out.println("Index (2), value: " + DataStructures.linkedList.get(2).value);
//
//        System.out.println("=======Set by index========");
//        DataStructures.linkedList.set(2,10);
//        DataStructures.linkedList.printList();
//
//        System.out.println("=======Insert========");
//        DataStructures.linkedList.insert(0, 33);
//        DataStructures.linkedList.insert(DataStructures.linkedList.getLength(), 44);
//        DataStructures.linkedList.insert(3,55);
//        DataStructures.linkedList.printList();
//
//        System.out.println("=======Remove========");
//        DataStructures.linkedList.remove(DataStructures.linkedList.getLength() - 1);
//        DataStructures.linkedList.printList();
//
//        System.out.println("=======Reverse========");
//        DataStructures.linkedList.reverse();
//        DataStructures.linkedList.printList();
    }
