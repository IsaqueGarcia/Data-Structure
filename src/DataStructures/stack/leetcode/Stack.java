...
//    public static void sortStack(DataStructures.stack.leetcode.Stack<Integer> DataStructures.stack){
//        //2 - 4 - 1 - 3
//
//        DataStructures.stack.leetcode.Stack<Integer> sortingStack = new DataStructures.stack.leetcode.Stack<>();
//
//        while (!DataStructures.stack.isEmpty()){
//            Integer temp = DataStructures.stack.pop(); // get the last element
//
//            while(!sortingStack.isEmpty() && sortingStack.peek() > temp){
//                Integer top = sortingStack.pop();
//                DataStructures.stack.push(top);
...
//            DataStructures.stack.push(sortingStack.pop());
//        }
//
//    }
    ...
    public static void main(String[] args) {
        ...
        //sortStack(DataStructures.stack);
